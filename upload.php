...
if(isset($_POST["submit"])) {
    ...
    $target_dir = "images/";
    // define name of image will upload witj 'fileToUpload' is name of tag input 
    ...
    if (file_exists($target_file)) {
        ...
        if(isset($_POST['ghide'])) {
            ...
            // Tạo file mới
            $new_file_name = uniqid() . '.' . $imageFileType; // Tạo tên file mới để tránh trùng lặp
            $new_target_file = $target_dir . $new_file_name; // Đường dẫn tới file mới
